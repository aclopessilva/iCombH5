...
INSERT INTO `atributos` VALUES (1,1,'suit','copas','vermelho'),(2,2,'suit','espadas','preto'),
(3,3,'suit','ouros','vermelho'),(4,4,'suit','paus','preto'),(5,5,'suit','copas','vermelho'),
(6,6,'suit','espadas','preto'),(7,7,'suit','ouros','vermelho'),(8,8,'suit','paus','preto'),
(9,9,'suit','copas','vermelho'),(10,10,'suit','espadas','preto'),(11,11,'suit','ouros','vermelho'),
(12,12,'suit','paus','preto'),(13,13,'suit','copas','vermelho'),(14,14,'suit','espadas','preto'),
(15,15,'suit','ouros','vermelho'),(16,16,'suit','paus','preto'),(17,17,'suit','copas','vermelho'),
(18,18,'suit','espadas','preto'),(19,19,'suit','ouros','vermelho'),(20,20,'suit','paus','preto'),
(21,21,'suit','copas','vermelho'),(22,22,'suit','espadas','preto'),(23,23,'suit','ouros','vermelho'),
(24,24,'suit','paus','preto'),(25,25,'suit','copas','vermelho'),(26,26,'suit','espadas','preto'),
(27,27,'suit','ouros','vermelho'),(28,28,'suit','paus','preto'),(29,29,'suit','copas','vermelho'),
(30,30,'suit','espadas','preto'),(31,31,'suit','ouros','vermelho'),(32,32,'suit','paus','preto'),
(33,33,'suit','copas','vermelho'),(34,34,'suit','espadas','preto'),(35,35,'suit','ouros','vermelho'),
(36,36,'suit','paus','preto'),(37,37,'suit','copas','vermelho'),(38,38,'suit','espadas','preto'),
(39,39,'suit','ouros','vermelho'),(40,40,'suit','paus','preto'),(41,41,'suit','copas','vermelho'),
(42,42,'suit','espadas','preto'),(43,43,'suit','ouros','vermelho'),(44,44,'suit','paus','preto'),
(45,45,'suit','copas','vermelho'),(46,46,'suit','espadas','preto'),(47,47,'suit','ouros','vermelho'),
(48,48,'suit','paus','preto'),(49,49,'suit','copas','vermelho'),(50,50,'suit','espadas','preto'),
(51,51,'suit','ouros','vermelho'),(52,52,'suit','paus','preto'),(64,1,'value','as',NULL),
(65,2,'value','as',NULL),(66,3,'value','as',NULL),(67,4,'value','as',NULL),(68,5,'value','2',NULL),
(69,6,'value','2',NULL),(70,7,'value','2',NULL),(71,8,'value','2',NULL),(72,9,'value','3',NULL),
(73,10,'value','3',NULL),(74,11,'value','3',NULL),(75,12,'value','3',NULL),(76,13,'value','4',NULL),
(77,14,'value','4',NULL),(78,15,'value','4',NULL),(79,16,'value','4',NULL),(80,17,'value','5',NULL),
(81,18,'value','5',NULL),(82,19,'value','5',NULL),(83,20,'value','5',NULL),(84,21,'value','6',NULL),
(85,22,'value','6',NULL),(86,23,'value','6',NULL),(87,24,'value','6',NULL),(88,25,'value','7',NULL),
(89,26,'value','7',NULL),(90,27,'value','7',NULL),(91,28,'value','7',NULL),(92,29,'value','8',NULL),
(93,30,'value','8',NULL),(94,31,'value','8',NULL),(95,32,'value','8',NULL),(96,33,'value','9',NULL),
(97,34,'value','9',NULL),(98,35,'value','9',NULL),(99,36,'value','9',NULL),(100,37,'value','10',NULL),
(101,38,'value','10',NULL),(102,39,'value','10',NULL),(103,40,'value','10',NULL),(104,41,'value','valete',NULL),
(105,42,'value','valete',NULL),(106,43,'value','valete',NULL),(107,44,'value','valete',NULL),(108,45,'value','dama',NULL),
(109,46,'value','dama',NULL),(110,47,'value','dama',NULL),(111,48,'value','dama',NULL),(112,49,'value','rei',NULL),
(113,50,'value','rei',NULL),(114,51,'value','rei',NULL),(115, 152,'value','rei',NULL),

(116,81,'value','1','vermelho'),(117,82,'value','2','vermelho'),(118,83,'value','3','vermelho'),
(119,84,'value','4','vermelho'),(120,85,'value','5','vermelho'),(121,86,'value','6','vermelho'),
(122,87,'value','7','vermelho'),(123,88,'value','8','vermelho'),(124,89,'value','9','vermelho'),
(125,90,'value','10','vermelho'),(126,91,'value','1','azul'),(127,92,'value','2','azul'),
(128,93,'value','3','azul'),(129,94,'value','4','azul'),(130,95,'value','5','azul'),
(131,96,'value','6','azul'),(132,97,'value','7','azul'),(133,98,'value','8','azul'),
(134,99,'value','9','azul'),(135,100,'value','10','azul'),(136,101,'value','1','amarelo'),
(137,102,'value','2','amarelo'),(138,103,'value','3','amarelo'),(139,104,'value','4','amarelo'),
(140,105,'value','5','amarelo'),(141,106,'value','6','amarelo'),(142,107,'value','7','amarelo'),
(143,108,'value','8','amarelo'),(144,109,'value','9','amarelo'),(145,110,'value','10','amarelo'),


(146,111,'jogador','1','goleiro'),(147,112,'jogador','2','zagueiro'),(148,113,'jogador','3','zagueiro'),
(149,114,'jogador','4','zagueiro'),(150,115,'jogador','5','meio-campo'),(151,116,'jogador','6','meio-campo'),
(152,117,'jogador','7','meio-campo'),(153,118,'jogador','8','meio-campo'),(154,119,'jogador','9','meio-campo'),
(155,120,'jogador','10','atacante'),(156,121,'jogador','11','atacante'),(157,122,'jogador','1','goleio'),
(158,123,'jogador','2','zagueiro'),(159,124,'jogador','3','zagueiro'),(160,125,'jogador','4','zagueiro'),
(161,126,'jogador','5','meio-campo'),(162,127,'jogador','6','meio-campo'),(163,128,'jogador','7','meio-campo'),
(164,129,'jogador','8','meio-campo'),(165,130,'jogador','9','meio-campo'),(166,131,'jogador','10','atacante'),
(167,132,'jogador','11','atacante'),(168,133,'jogador','1','goleiro'),(169,134,'jogador','2','zagueiro'),
(170,135,'jogador','3','zagueiro'),(171,136,'jogador','4','zagueiro'),(172,137,'jogador','5','meio-campo'),
(173,138,'jogador','6','meio-campo'),(174,139,'jogador','7','meio-campo'),(175,140,'jogador','8','meio-campo'),
(176,141,'jogador','9','meio-campo'),(177,142,'jogador','10','atacante'),(178,143,'jogador','11','atacante'),
(179,144,'jogador','1','goleio'),(180,145,'jogador','2','zagueiro'),(181,146,'jogador','3','zagueiro'),
(182,147,'jogador','4','zagueiro'),(183,148,'jogador','5','meio-campo'),(184,149,'jogador','6','meio-campo'),
(185,150,'jogador','7','meio-campo'),(186,151,'jogador','8','meio-campo'),(187,152,'jogador','9','meio-campo'),
(188,153,'jogador','10','atacante'),(189,154,'jogador','11','atacante'),(190,111,'time','azul',NULL),
(191,112,'time','azul',NULL),(192,113,'time','azul',NULL),(193,114,'time','azul',NULL),(194,115,'time','azul',NULL),
(195,116,'time','azul',NULL),(196,117,'time','azul',NULL),(197,118,'time','azul',NULL),(198,119,'time','azul',NULL),
(199,120,'time','azul',NULL),(200,121,'time','azul',NULL),(201,122,'time','amarelo',NULL),(202,123,'time','amarelo',NULL),
(203,124,'time','amarelo',NULL),(204,125,'time','amarelo',NULL),(205,126,'time','amarelo',NULL),(206,127,'time','amarelo',NULL),
(207,128,'time','amarelo',NULL),(208,129,'time','amarelo',NULL),(209,130,'time','amarelo',NULL),(210,131,'time','amarelo',NULL),
(211,132,'time','amarelo',NULL),(212,133,'time','verde',NULL),(214,134,'time','verde',NULL),(215,135,'time','verde',NULL),
(216,136,'time','verde',NULL),(217,137,'time','verde',NULL),(218,138,'time','verde',NULL),(219,139,'time','verde',NULL),
(220,140,'time','verde',NULL),(221,141,'time','verde',NULL),(222,142,'time','verde',NULL),(223,143,'time','verde',NULL),
(224,144,'time','vermelho',NULL),(225,145,'time','vermelho',NULL),(226,146,'time','vermelho',NULL),(227,147,'time','vermelho',NULL),
(228,148,'time','vermelho',NULL),(229,149,'time','vermelho',NULL),(230,150,'time','vermelho',NULL),(231,151,'time','vermelho',NULL),
(232,152,'time','vermelho',NULL),(233,153,'time','vermelho',NULL),(234,154,'time','vermelho',NULL);
