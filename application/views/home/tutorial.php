        ...
        <div class="container-fluid">
                ...
                <div class="content-section-a">  
                    ...
                    <div class="col-sm-2 hidden-xs">
                        <div class="tutorial-item-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url()?>user_guide/img/tutorial/lapis.png" alt="">
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <p>
            ...
            <div class="row">
                <div class="content-section-b"> 
                    ...
                    <div class="col-sm-2  hidden-xs">
                        <div class="tutorial-item-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url()?>user_guide/img/tutorial/lampada.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="content-section-a"> 
                    ...
                    <div class="col-sm-2  hidden-xs">
                        <div class="tutorial-item-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url()?>user_guide/img/tutorial/estagios.png" alt="">
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <p>
            ...
            <div class="row">
                <div class="content-section-b"> 
                    ...
                    <div class="col-sm-2  hidden-xs">
                        <div class="tutorial-item-image">
                            <img src="<?php echo base_url()?>user_guide/img/tutorial/interrogacao.png" class="img-responsive img-circle" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="content-section-a"> 
                    ...
                    <div class="col-sm-2 hidden-xs">
                        <div class="tutorial-item-image">
                            <img src="<?php echo base_url()?>user_guide/img/tutorial/exclamacao.png" class="img-responsive img-circle" alt="">
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <p>
